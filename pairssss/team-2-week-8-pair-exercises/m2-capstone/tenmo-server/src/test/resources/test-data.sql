...
INSERT INTO account (account_id, user_id, balance) values (2004,1001, 1000.00);
INSERT INTO account (account_id, user_id, balance) values (2005,1002, 1500.00);
INSERT INTO account (account_id, user_id, balance) values (2006,1003, 0.00);


INSERT INTO transfer (transfer_id, transfer_type_id, transfer_status_id,account_from, account_to, amount)
VALUES(1, 2, 2, 2004, 2005, 500.00);
INSERT INTO transfer (transfer_id, transfer_type_id, transfer_status_id,account_from, account_to, amount)
VALUES(2, 2, 2, 2005, 2006, 10.00);
INSERT INTO transfer (transfer_id, transfer_type_id, transfer_status_id,account_from, account_to, amount)
VALUES(3, 2, 2, 2004, 2005, 80.00);
