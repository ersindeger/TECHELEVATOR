...
public class JdbcUserDao implements UserDao {
    ...
    public List<User> retrieveAllUsersMinusSelf(String username) {
        List<User> users = new ArrayList<>();

        String sql = "SELECT t.user_id, t.username FROM tenmo_user t JOIN account a ON t.user_id = a.user_id " +
                "WHERE t.username != ?;";
