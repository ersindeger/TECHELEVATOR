...
function isAdmitted(gpa, satScore = 0, recommendation = false){ 
    ...
    if( gpa > 4.0 || satScore > 1300 ) { return true; }
     else if ( gpa > 3.0 && recommendation == true ) { return true; }
     else if ( satScore > 1200 && recommendation == true ) { return true; }
     else { return false ; }
}
...
function addAll () {
    ...
    // return arrayToSum.filter(sum(...num));
 ...
 */
 function getFullAddressesOfProperties(){ array =>{
        ...
        object = [
            {key: streetNumber, value: array[0]}, 
            {key: streetName, value: array[1]},
            {key: streetType, value: array[2]}, 
            {key: city, value: array[3]},
            {key: state, value: array[4]},
            {key: zip, value: array[5]},
            ] 
    }
    return array; 
 }
...
// function getSumOfSubArrayValues (function getSumOfArray1 (array1)){
