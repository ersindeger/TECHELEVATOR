...
export default {
  ...
  methods: {
    ...
    submitForm() {
       ...
       homeService.addHome(this.home).then( response => {
    ...
    handleErrorResponse (error) {
      ...
      if (error.response) {
          ...
          this.errorMsg = "Unable to reach server. Server could not be reached";
      }
      else {
          //catch all
          this.errorMsg = "Bad crap happened... Better find another dev"
      }
