...
public class UI {
    ...
    public int printSubMenu() {
        ...
        System.out.println("1. Add an Owned home");
        System.out.println("2. Add a Rental Home");
    ...
    public Home askUserForRentalHomeInfo () {

        //create a bunch of souts asking user questions and then populate a home object
