...
public class Tutorial {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, String> project : projects.entrySet()) {
            System.out.println("The key " + project.getKey() +
                    " is linked to the value " + project.getValue());
        }

        /** Step Four: Remove items from a Map **/

        //projects.remove("Grace");   <=== removes KEY "Grace"
                            // and corresponding value from Map.
