...
public class NinjaTracker {
    ...
    public static void main(String[] args) {
        ...
        //be able to put values into an array
        ...
        System.out.println("Length of an array is: " + ninjaNames.length);

        //be able to get data out of an array
        System.out.println("The 5th element contains ninja: " + ninjaNames[4]);
        ...
        //be able to get 2nd from last element in the array
        String nameAtSecondToLast = ninjaNames[ninjaNames.length - 2];
        System.out.println(nameAtSecondToLast);



        //be able to loop through the array and print out the values
