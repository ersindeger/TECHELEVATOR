...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        ...
        HttpEntity<Reservation> entity = new HttpEntity<>(newReservation, headers );   // entity is a wrapper object that represents the HTTP packet request
                                                                                       // new Reservation will get placed in the message body
    ...
    public boolean updateReservation(Reservation updatedReservation) {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);    //sets the header's application type to JSON
        HttpEntity<Reservation> entity = new HttpEntity<>(updatedReservation, headers );   // entity is a wrapper object that represents the HTTP packet request
                                                                                            // updated Reservation will get placed in the message body
